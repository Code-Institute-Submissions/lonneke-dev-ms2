var source1 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Bee Gees - Stayin' Alive.mp3";
var source2 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Billy Joel - Piano Man.mp3";
var source3 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Bobby McFerrin - Dont Worry Be Happy.mp3";
var source4 = document.getElementsByClassName("question-audio").src= "assets/audio-files/David Bowie - Heroes.mp3";
var source5 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Europe - The Final Countdown.mp3";
var source6 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Stromae - Formidable.mp3";
var source7 = document.getElementsByClassName("question-audio").src= "assets/audio-files/George Ezra - Budapest.mp3";
var source8 = document.getElementsByClassName("question-audio").src= "assets/audio-files/George Michael - Careless Whisper.mp3";
var source9 = document.getElementsByClassName("question-audio").src= "assets/audio-files/The Beatles - Here Comes The Sun.mp3";
var source10 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Stevie Wonder - Isnt She Lovely.mp3";
var source11 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Pat Benatar - Love Is A Battlefield.mp3";
var source12 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Plain White T's - Hey There Delilah.mp3";
var source13 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Queen - Bohemian Rhapsody.mp3";
var source14 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Ricky Martin - Livin La Vida Loca.mp3";
var source15 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Justin Timberlake - SexyBack.mp3";
var source16 = document.getElementsByClassName("question-audio").src= "assets/audio-files/The Beatles - Sgt. Pepper's Lonely Hearts Club Band.mp3";
var source17 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Simple Minds - Dont You.mp3";
var source18 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Stevie Wonder Superstition.mp3";
var source19 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Eurythmics - Sweet Dreams.mp3";
var source20 = document.getElementsByClassName("question-audio").src= "assets/audio-files/The Cranberries - Zombie.mp3";
var source21 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Jimi Hendrix - All Along The Watchtower.mp3";
var source22 = document.getElementsByClassName("question-audio").src= "assets/audio-files/The White Stripes - Seven Nation Army.mp3";
var source23 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Vance Joy - Riptide.mp3";
var source24 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Milky Chance - Stolen Dance.mp3";
var source25 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Hozier - Take Me To Church.mp3";
var source26 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Radiohead - Creep.mp3";
var source27 = document.getElementsByClassName("question-audio").src= "assets/audio-files/The Clash - Should I Stay or Should I Go.mp3";
var source28 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Ariana Grande - God is a woman.mp3";
var source29 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Dolly Parton - Jolene.mp3";
var source30 = document.getElementsByClassName("question-audio").src= "assets/audio-files/Billie Eilish - bad guy.mp3";
